...
class Encoder(nn.Module):
    """Transformer encoder"""
    def __init__(self, d_model, N, heads, dropout=0.1, hidden_size=2048, max_seq_len=16):
        super().__init__()
        self.N = N
...
class Transformer(nn.Module):
    """Transformer"""
    def __init__(self, n_items, d_model, N, heads, dropout=0.1, hidden_size=2048, max_seq_len=16):
        super().__init__()
        self.encoder = Encoder(d_model, N, heads, dropout, hidden_size, max_seq_len)
